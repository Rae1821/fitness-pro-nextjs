...
const Stats = ({ data }) => {
  ...
  return (
    <div className="flex w-full flex-col items-center justify-center gap-4">
      <div className="stats stats-vertical w-full items-center justify-center bg-transparent px-2 text-center md:stats-horizontal">
        ...
        <div className="stat bg-neutral shadow-md">
          ...
          <div className="stat-desc mt-1 flex items-center justify-center gap-1">
            <span>
