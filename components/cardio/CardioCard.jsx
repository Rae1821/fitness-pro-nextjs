...
const formattedDate = new Date(post.date).toLocaleDateString();
  ...
  return (
    <div>
    {/* Daisy UI Collapse */}
        <div className="collapse collapse-plus border-b border-b-neutral font-display md:px-2 w-full bg-base-100 mb-4 text-base-200 sm:max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto items-center hover:bg-accent rounded-tr-2xl rounded-tl-2xl pt-2">
